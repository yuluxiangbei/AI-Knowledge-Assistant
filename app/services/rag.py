...
from app.services.vector_store import search_chunks,embedder,ensure_collection,upsert_chunks


llm = OpenAI(api_key=get_settings().DEEPSEEK_API_KEY, base_url=get_settings().DEEPSEEK_BASE_URL)


def generate_answer(client:QdrantClient,user_id:int,question:str,top_k:int):
...
if __name__ == "__main__":
  ...
  print(generate_answer(client=client,user_id=1,question="FastAPI 基于什么实现异步？",top_k=2))
  print("结束")